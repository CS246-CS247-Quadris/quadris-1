...
lBlock::lBlock(gameBoard * pBoard):Block(pBoard) {
	cells.push_back(new Cell(3,0,'l',current_level,true));
	cells.push_back(new Cell(3,1,'l',current_level,true));
	cells.push_back(new Cell(3,2,'l',current_level,true));
...
void lBlock::rotateCCW() {
	...
	cells.at(3)->setXY(cells.at(3)->x-1,cells.at(3)->y-2);
  } else if(cells.at(2)->y > cells.at(3)->y){
	...
	cells.at(3)->setXY(cells.at(3)->x+2,cells.at(3)->y);
  }else if(cells.at(2)->x < cells.at(3)->x){
	...
	cells.at(2)->setXY(cells.at(2)->x,cells.at(2)->y+2);
