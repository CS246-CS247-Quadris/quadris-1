...
void jBlock::rotateCCW() {
  ...
  if(cells.at(0)->x > cells.at(3)->x) {
	...
	cells.at(3)->setXY(cells.at(0)->x+1,cells.at(0)->y);
  } else if(cells.at(0)->y > cells.at(3)->y){
  ...
  }else if(cells.at(0)->x < cells.at(3)->x){
	...
	cells.at(3)->setXY(cells.at(0)->x+1,cells.at(0)->y-1);
  }
}
